...
public class BuiltinTags
{
    ...
    public static readonly Guid s_OriginalFileDateID = new Guid("BDE93371-2422-489E-86AD-462E2EC975CD");
    ...
    public static readonly Metatag s_OriginalFileDate = Metatag.Create(s_CatRootID, "originalFileDate", "originalFileDate", MetatagStandards.Standard.Cat, s_OriginalFileDateID);
