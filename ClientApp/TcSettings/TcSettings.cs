            ...
            .Build(s_uri, "Settings")
                ...
                .SetRepeating(CreateProfilesRepeatContext, AreRemainingProfiles, CommitProfilesRepeatItem)
                    .AddChildElement("Options")
                        ...
                        .AddAttribute("value", (_, context) => context!.GetDictionaryValue<string, Profile>().ShowAsyncLogOnStart?.ToString() ?? "false", (_, value, context) => context!.GetDictionaryValue<string, Profile>().ShowAsyncLogOnStart = bool.Parse(value))
