...
public class ListSupport
{
    ...
    ----------------------------------------------------------------------------*/
    public static SortedList<T2, T3> AddItemToMappedSortedList<T1, T2, T3>(Dictionary<T1, SortedList<T2, T3>> map, T1 key, T2 itemKey, T3 newItem)
        where T1 : notnull
        where T2 : notnull
    {
