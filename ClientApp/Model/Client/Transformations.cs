...
{
    public static Guid s_rotateTransform = BuiltinTags_Current.s_TransformRotateID;
    public static Guid s_mirrorTransform = BuiltinTags_Current.s_TransformMirrorID;
