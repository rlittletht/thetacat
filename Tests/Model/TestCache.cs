...
// DoForegroundCache is going to:
    ...
    public static void TestQueueCacheDownloads_Client1_NoCoherencyFailures_AllItemsQueued()
    {
        ...
        List<MediaItem> MediaItems_1_4 =
            new()
            {
                new MediaItem(new ServiceMediaItem() { Id = TestMedia.media1, VirtualPath = "media1.jpg", MD5 = "md5-1==", MimeType = "image/jpeg", State = "pending" }),
                ...
                new MediaItem(new ServiceMediaItem() { Id = TestMedia.media4, VirtualPath = "media4.jpg", MD5 = "md5-4==", MimeType = "image/jpeg", State = "pending" }),
            };
